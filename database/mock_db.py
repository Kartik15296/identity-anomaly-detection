...
USER_PROFILES = {
    "u01": {
        ...
        "login_hour_weights": {
            "8":  {"weight": 4.2, "last_seen": "2026-03-13 08:30:00"},
            "9":  {"weight": 5.8, "last_seen": "2026-03-13 09:15:00"},
            "10": {"weight": 3.1, "last_seen": "2026-03-12 10:05:00"},
            "11": {"weight": 1.9, "last_seen": "2026-03-11 11:00:00"},
        },
    ...
    "u02": {
        ...
        "login_hour_weights": {
            "9":  {"weight": 3.5, "last_seen": "2026-03-12 09:55:00"},
            "10": {"weight": 4.8, "last_seen": "2026-03-12 10:20:00"},
            "11": {"weight": 2.9, "last_seen": "2026-03-11 11:00:00"},
            "12": {"weight": 1.5, "last_seen": "2026-03-10 12:30:00"},
        },
    ...
    "u03": {
        ...
        "login_hour_weights": {
            "8": {"weight": 6.3, "last_seen": "2026-03-12 08:45:00"},
            "9": {"weight": 4.1, "last_seen": "2026-03-12 08:50:00"},
        },
...
PEER_CLUSTERS = {
    "cluster_eng_blr": {
        ...
        "common_departments": ["Engineering"],
        "common_roles": ["Software Engineer", "Senior Engineer"],
        "common_offices": ["Bangalore"],
        "avg_failed_attempts": 0.1,
    },
    "cluster_prod_mum": {
        ...
        "common_departments": ["Product"],
        "common_roles": ["Product Manager"],
        "common_offices": ["Mumbai"],
        "avg_failed_attempts": 0.2,
    },
    "cluster_devops_hyd": {
        ...
        "common_departments": ["DevOps"],
        "common_roles": ["DevOps Engineer"],
        "common_offices": ["Hyderabad"],
        "avg_failed_attempts": 0.0,
    },
}
